...
// Implemented with pdf-lib. Read-only: no write/set-metadata operation is
// scaffolded anywhere in the UI, so there is nothing to wire a setter into.
// pdf-lib's `PDFDocument.load()` already parses the document's Info
// dictionary, so

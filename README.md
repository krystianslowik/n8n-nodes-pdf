...
- **0.2.3 – 0.2.7**: Documentation and metadata updates — README refresh with
  workflow screenshot and version history, author contact metadata, and the
  codex node identifier fixed to the fully-qualified format
  (`n8n-nodes-pdf.pdfToolkit`). No functional changes. (0.2.5 was skipped.)
